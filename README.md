...
- **プラン**（無料プランあり＝ロックなし。**Premium は初回 7 日間の無料トライアル付き**）:
  ...
  | プラン | 月額 | 年額 | 取り込み冊数 | AI生成/月 | クラウド同期 |
  |---|---|---|---|---|---|
  | **Free** | ¥0 | — | 1 冊 | 1 ページ | なし |
  | **Standard** | ¥300 | ¥2,500 | 10 冊 | 10 ページ | なし |
  | **Pro** | ¥600 | ¥5,000 | 無制限 | 30 ページ | あり（R2・合計 5GB / 1ファイル 100MB） |
  | **Premium** | ¥980 | ¥8,000 | 無制限 | 200 ページ | あり（＋将来の適応SRS） |

  - サインインすれば未契約でも **Free（1 冊）** として使え、ペイウォールで強制ロックはしません。
  - 開発者アカウント（管理者メール）は常に無制限。
  - **無料トライアル**: Premium のみ初回 7 日間無料。トライアル中は AI 生成を月 30 ページに制限（`TRIAL_GEN_PAGES`）。
