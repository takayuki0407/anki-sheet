...
- **プラン**（無料プランあり＝ロックなし。**Premium は初回 7 日間の無料トライアル付き**）:
  ...
  |---|---|---|---|---|---|
  | **Free** | ¥0 | — | 1 冊 | 1 回 | なし |
  | **Standard** | ¥300 | ¥2,500 | 10 冊 | 10 回 | なし |
  | **Pro** | ¥600 | ¥5,000 | 無制限 | 30 回 | あり（R2・合計 5GB / 1ファイル 100MB） |
  | **Premium** | ¥980 | ¥8,000 | 無制限 | 200 回 | あり（＋「今日の復習」= SM-2 SRS） |

  - **AI 生成の単位は「回」＝ 1 ページ × 問題の種類（○× / 4択）**。同じ（ページ×種類）の再生成は枠を消費しません。
