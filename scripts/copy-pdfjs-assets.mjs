// Copies pdf.js cMaps + standard fonts into public/ so they are served as static
// assets. These are REQUIRED to render CJK (CID) fonts — without them, pdf.js
// silently fails to draw the glyphs and getTextContent() returns nothing.
// Runs on postinstall / predev / prebuild so node_modules stays the source of truth
